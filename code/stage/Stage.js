...
eventKedamaMidboss = function (world, power) {
    ...
    kedama.addAttack(false, null, nonSpell, world.difficulty, 400, 500);
...
eventOrb = function (world) {
    ...
    orb.addAttack(false, null, nonSpell, world.difficulty, 100, 500);
    orb.addSpell(SPELL.orbAlpha, world.difficulty);
    orb.addAttack(false, null, nonSpell, world.difficulty, 100, 800);
